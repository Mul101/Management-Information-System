...
<div class="row">
        <div class="col-lg-4">
           <div class="profile-card-4 z-depth-3">
            <div class="card">
              <div class="card-body text-center rounded-top" style="background-color: #C88D70;">
               <div class="user-box">
                <img src="img/puss1.jpg" alt="user avatar">
              </div>
              <h5 class="mb-1 text-white">Fita M
              </h5>
              ...
              <div class="card-body">
                ...
                <li class="list-group-item">
                  ...
                  <div class="list-details">
                    <span>523@students.uii.ac.id</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-hover table-striped">
                                <tbody>                                    
                                    <tr>
                                        <td>
                                            <strong>Mulia</strong> menambahkan stok bahan <strong>`Laporan`</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Ratu</strong> melakukan pencatatan di <strong>`Laporan`</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Fita</strong> membeli stok bahan <strong>`Transaksi`</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                ...
                <div class="tab-pane" id="messages">
    			   ...
    			   <button type="button" class="close" data-dismiss="alert">×</button>
				    ...
				    <div class="alert-message">
				      <span><strong>Info!</strong> Barang hampir habis.</span>
				    </div>
                  </div>
                    <table class="table table-hover table-striped">
                        <tbody>                                    
                            <tr>
                                <td>
                                   <span class="float-right font-weight-bold">3 hrs ago</span> Redvelvet masuk kategori terbaik..
                                </td>
                            </tr>
                            <tr>
                                <td>
                                   <span class="float-right font-weight-bold">Yesterday</span> Banyak produk yang terpesan..
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <div class="tab-pane" id="edit" >
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Fita">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Last name</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="M">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value="523@students.uii.ac.id">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="url" value="ASA">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="password" value="0001">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Confirm password</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="password" value="1112">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label"></label>
