...
$beli = query("SELECT * FROM pembelian ORDER BY tgl_beli DESC");
?>
                    ...
                    <table id="datatablesSimple">
                        ...
                        <!-- <table border="2" cellpadding="10" cellspacing="0" align="center"> -->
                            <tr  bgcolor= #c78d69>
                                ...
                                <th style ="color: #ffffff">Nama Bahan</th>
                                <th style ="color: #ffffff" >Jumlah Beli</th>
                                <th style ="color: #ffffff">Harga Total</th>
                            ...
                            <tr>
                                ...
                                <td align = "center"><?= $row["jml_beli"]; ?></td>
                                <td align = "center"><?= $row["hrg_tot"]; ?></td>
                                <td>
                                    <a class="btn btn-sm btn-success"   href="ubah2.php?id=<?= $row["id"]; ?>">Edit </a>                                 
                                </td>
                                <td>
                                <a class="btn btn-sm btn-danger" href="hapus2.php?id=<?= $row["id"]; ?>" onclick="
