        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content" style="margin-top:5px">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Input Data Pembelian</h1>
            ...
            <form action="" method="post">
                <table>
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                                    ...
                                    <input type="text" class="form-control" id="jml_beli" name="jml_beli" required>
                                    <!-- <div class="valid-feedback">Valid.</div> -->
                                    <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    <div class="form-group" style="margin-top: 15px;">
                                    <label for="hrg_tot">Harga Total :</label>
                                    <input type="text" class="form-control" id="hrg_tot" name="hrg_tot" required>
                                    <!-- <div class="valid-feedback">Valid.</div> -->
                                    <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    <tr>
